...
type BattleState struct {
	...
	opponent_delay_timer *ebiten_extended.Timer
}




func (bs *BattleState) Enter() {
}

func (bs *BattleState) Exit() {
}
...
func (bs *BattleState) CreateMonster(monster *MonsterData, index int, posIndex int, entity string) {
	// This function is a placeholder for the actual implementation
	// It should create a new monster sprite and add it to the battle state
